...
const char R_scanWifi[] PROGMEM = "/scanWifi";
const char R_saveWifi[] PROGMEM = "/saveWifi";
const char R_cancelWifi[] PROGMEM = "/cancelWifi";
...
const char HTTP_HEAD_JSON[] PROGMEM = "application/json; charset=utf-8";
